...
function updateAll() {
  if (
    confirm(
      "Please verify that all the information entered in correct and spelled/abbreviated correctly.  If you pulled in your information through your asurite, it may have abbreviated some contact information.  Press OK to proceed"
    )
  ) {
    if (
      (showMask(),
  ...
  return "" !== t
    ? ((slitWords = e.split(t)),
      ...
      null != slitWords[0] && null != slitWords[1]
        ? ((string =
            slitWords[0] +
            '<a style="color:#8C1D40; font-size:8pt; font-family:arial, sans-serif;" href="' +
            a +
            '">' +
            t +
            "</a> " +
    ...
    complete: function (e) {
      ...
      try {
        ...
        (a = a[0]),
          ...
          $("#cell").val(a.cell),
          $("#email").val(a.email),
          $("#addLine1").val(a.addLine1),
          $("#addLine2").val(a.addLine2),
          $("#addLine3").val(a.addLine3);
